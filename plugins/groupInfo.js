let handler = async (m, { conn, participants, groupMetadata, text }) => {
    ...
    try {
        ...
        let { isBanned, welcome, detect, sWelcome, sBye, sPromote, sDemote, antiLink, expired, descUpdate, stiker, antispam, antitroli, antivirtex } = global.db.data.chats[m.chat]
